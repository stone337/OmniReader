...
def main(page: ft.Page):
                ...
                for item in nb_data:
                    ...
                    notebook_list_container.controls.append(
                        ft.Container(
                            ...
                            on_click=lambda e, w=word, p=phonetic, t=translation: show_sheet(w, p, t) # 点词就地升卡，完全不跳 Tab！
                        )
                    )
            ...
            controls=[
                ...
                ft.Container(
                    content=ft.Column([
                        ...
                        # 发音按钮
                        ft.Container(
                            content=ft.ElevatedButton("🔊 播放发音", color=PRIMARY_COLOR, bgcolor="#F2F2F7", on_click=lambda e: play_word_pronunciation(lbl_rev_word.value)),
                            alignment=ft.alignment.Alignment(0, 0),
    ...
    def start_review_flow():
        ...
        def select_review_queue(queue):
            ...
            # 显示背诵卡，隐藏选择面板
            review_overlay.content.controls[1].visible = False # choice_box 隐藏
            review_overlay.content.controls[2].visible = True  # 背诵卡片 显示
            load_review_card()

        review_overlay.content.controls[1].visible = True  # 显示选择看板
        review_overlay.content.controls[2].visible = False # 隐藏背诵卡片
    ...
    main_layout = ft.Stack(
        controls=[
            ...
            bottom_sheet,     # 悬浮 Bottom Sheet 叠在最上方
            review_overlay    # 全屏复习大遮罩层叠在最上方
        ],
        expand=True
    )
